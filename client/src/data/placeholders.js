...
export const placeholderCategories = {
    client: {
        ...
        placeholders: [
            ...
            { key: 'clientEmail', label: 'Client Email', example: 'john@example.com' },
            { key: 'clientPhone', label: 'Client Phone', example: '+91 9876543210' },
            { key: 'clientAddress', label: 'Client Address', example: '123 Main St, City' },
    ...
    project: {
        ...
        placeholders: [
            ...
            { key: 'projectDescription', label: 'Project Description', example: 'Complete website redesign with modern UI' },
            ...
            { key: 'deliverables', label: 'Deliverables', example: 'Website, Documentation' }
        ]
    },
    pricing: {
    ...
    company: {
        ...
        icon: '🏢',
        placeholders: [
            { key: 'companyName', label: 'Company Name', example: 'Your Agency' },
            { key: 'companyEmail', label: 'Company Email', example: 'contact@agency.com' },
            { key: 'companyPhone', label: 'Company Phone', example: '+91 9876543210' },
            { key: 'companyAddress', label: 'Company Address', example: '456 Business St' },
            { key: 'companyWebsite', label: 'Company Website', example: 'www.agency.com' },
            { key: 'companyGstin', label: 'Company GSTIN', example: '27XXXXXXXXXX1ZX' },
    ...
    document: {
        ...
        icon: '📄',
        placeholders: [
            { key: 'documentNumber', label: 'Document Number', example: 'PROP-2024-0001' },
            { key: 'invoiceNumber', label: 'Invoice Number', example: 'INV-202401-0001' },
            { key: 'proposalNumber', label: 'Proposal Number', example: 'PROP-2024-0001' },
            { key: 'agreementNumber', label: 'Agreement Number', example: 'AGR-2024-0001' },
    ...
    dates: {
        ...
        placeholders: [
            ...
            { key: 'completionDate', label: 'Completion Date', example: '15 Mar 2024' }
        ]
    },
    custom: {
        label: 'Custom Fields',
...
export const templateTypes = [
    { id: 'proposal', label: 'Proposal', icon: '📋', description: 'Proposal templates' },
    { id: 'agreement', label: 'Agreement', icon: '📜', description: 'Contract and agreement templates' },
    { id: 'invoice', label: 'Invoice', icon: '🧾', description: 'Invoice templates' },
    { id: 'email', label: 'Email', icon: '📧', description: 'Email templates' },
    { id: 'custom', label: 'Custom', icon: '⚙️', description: 'Custom templates' }
]
